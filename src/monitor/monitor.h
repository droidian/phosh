 ...
 * @PHOSH_MONITOR_CONNECTOR_TYPE_HWCOMPOSER_BUILTIN: a built-in hwcomposer connector
 * @PHOSH_MONITOR_CONNECTOR_TYPE_HWCOMPOSER: an hwcomposer connector
 *
...
typedef enum _PhoshMonitorConnectorType
{
  ...
  PHOSH_MONITOR_CONNECTOR_TYPE_HWCOMPOSER_BUILTIN = 40,
  PHOSH_MONITOR_CONNECTOR_TYPE_HWCOMPOSER = 41,
} PhoshMonitorConnectorType;
